...
import { Star, Square, CheckSquare, MoreVertical, RefreshCcw, ChevronLeft, ChevronRight } from "lucide-react";
...
const MOCK_MESSAGES = [
  ...
  },
  {
    ...
    snippet: "A new sign-in to Slack was detected on a Linux device in Paris, France...",
    date: "May 8",
    isRead: true,
    isStarred: false,
  },
  {
    id: "4",
    sender: "Google Cloud",
    subject: "Action Required: Your Cloud project is nearing quota limits",
    snippet: "Dear Developer, your project 'hemdaimail-prod' has reached 85% of its...",
    date: "May 7",
    isRead: false,
    isStarred: false,
  },
